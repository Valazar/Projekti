...
void ConfigureADCPins(void)
{
    ...
    TRISBbits.TRISB7=1;//pecurka taster za reset glcd
    ADPCFGbits.PCFG7=1;
    
    ADPCFGbits.PCFG8=0; //analogni za tacpanel
    TRISBbits.TRISB8=1;// pin B8 kao ulazni
    ADPCFGbits.PCFG9=0; //analogni za tacpanel
	TRISBbits.TRISB9=1;//pin B9 kao ulazni
    
    ADPCFGbits.PCFG10=0; //definisemo da pin B10 bude analogni za povezivanje fotootpornika
    TRISBbits.TRISB10=1; //pin B10 ulazni
    
    ADPCFGbits.PCFG11=0; //definisemo da pin B11 bude analogni za povezivanje LM335
    TRISBbits.TRISB11=1; //pin B11 ulazni
    
    ADPCFGbits.PCFG12=1; //definisemo da pin B12 bude digialni za povezivanje SERVA
    TRISBbits.TRISB12=0; //pin B12 izlazni 
    
    TRISAbits.TRISA11=0; //izlazni signal za buzzer
    TRISFbits.TRISF6=0;//signal za diodu koju pali fotootpornik
    TRISDbits.TRISD8=1; // pin za vezivanje pir senzora
    TRISDbits.TRISD9=0;  //signal za diodu koju pali pir senzor
